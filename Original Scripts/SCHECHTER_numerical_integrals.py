...
Min_int0 =  pow(10,-0.4*(-12+48.6)) * FACTOR_LUM   # Lower limit luminosity for integration 1 (M_UV=-12)
...
Max_int = pow(10,-0.4*(-31.5+48.6)) * FACTOR_LUM     # Defining an upper limit for integration just for numeric resaons

os.system('rm z_puv.cat') # delete file to begin with

print >> open('z_puv.cat','a'), '#  Redshift   p_UV_TOTAL   p_UV_12   p_UV_13   p_UV_17'
...
for i in range(len(Redshifts)):
    ...
    print >> open('z_puv.cat','a'), Redshifts[i], log10(integral_analytical), log10(integral1D_m0[0]), log10(integral1D_m[0]), log10(integral1D_m2[0])
    #print integral2D_m