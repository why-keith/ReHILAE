...
ts = np.linspace(0.05,14,10000000)
zs= ((((28./(ts))-1.)**(1./2.)-1.))
t0 = 0.0

#for f_esc0 in arange(0.05,0.3,0.05):
for f_esc0 in arange(0.05,0.2,0.05):
...
# Define the axis
axis([0,1.5,-0.05,1.05])

# Label axis
xlabel(r'Cosmic time since Big Bang (billion years)', {'color':'k', 'fontsize': 21})
ylabel(r'Ionised Fraction (%)', {'color':'k', 'fontsize': 21})

xticks((0,0.25,0.5,0.75,1.0,1.25,1.5),(0,0.25,0.5,0.75,1.0,1.25,1.5), color='k', size=16)
