...
def E_ion(z):#Hz/erg
    return 10**25.6 #10**(24.4 + math.log10(1 + z)) #10**25.6 
...
def f_esc_UV(z): #escape fraction of UV
        return 0.23 #(f_esc_zero*((1+z)/3)**alpha)/100 # UV escape fraction

def n_ion_dot_UV(z): #s⁻¹ cm⁻³ 
    return f_esc_UV(z) * E_ion(z) * (10**(-5.288*math.log10(z+1) + 30.39894)) / (2.938e+73) # (2.938e+73) converts from Mpc^-3 to cm^-3  - full units s^-1 Mpc^-3
